...
% plots
if signals
    figure('PaperSize',[6,5],'PaperPosition',[0,0,6,5]);
    subplot('Position',[0.1,0.7,0.85,0.25]);
    plot([1:n]',xs,'k-','LineWidth',1);
    set(gca,'XLim',[0,n],'YLim',[-4,4],'XTickLabel',[],'YTick',[-4,0,4],'FontSize',12);
    ylabel('x_s','FontSize',12);
    subplot('Position',[0.1,0.4,0.85,0.25]);
    plot([1:n]',xsn,'k-','LineWidth',1);
    set(gca,'XLim',[0,n],'YLim',[-4,4],'XTickLabel',[],'YTick',[-4,0,4],'FontSize',12);
    ylabel('x_s + \epsilon_1','FontSize',12);
    subplot('Position',[0.1,0.1,0.85,0.25]);
    plot([1:n]',Out.x,'k-','LineWidth',1);
    set(gca,'XLim',[0,n],'YLim',[-4,4],'YTick',[-4,0,4],'FontSize',12);
