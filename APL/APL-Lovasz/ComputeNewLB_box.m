...
%        cvx_end
    ...
    lb_prob.blx = -domain.Bnd*ones(domain.n,1);
    lb_prob.bux = domain.Bnd*ones(domain.n,1);
else,
    if mode == 0,
%            cvx_begin
%            cvx_quiet(true);
...
%            cvx_end
        ...
        lb_prob.blx = [-domain.Bnd*ones(domain.n,1); -inf];
        lb_prob.bux = [domain.Bnd*ones(domain.n,1); inf];
    end
end;
